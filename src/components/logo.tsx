export function Logo() {
  return (
    <div className="flex items-center gap-2">
        ...
        <g>
          ...
          <g transform="translate(5, 5) scale(0.9)">
            ...
            <g transform="translate(60, 100) scale(0.4)">
              ...
              <circle cx="20" cy="65" r="15" fill="#B56A2C" stroke="white" stroke-width="2" />
              <circle cx="80" cy="65" r="18" fill="#B56A2C" stroke="white" stroke-width="2" />
            </g>
            ...
            />
             <path d="M120,135 H 170" stroke="#00AEEF" stroke-width="2" />
              <path d="M125,130 H 165" stroke="#00AEEF" stroke-width="2" />
              <path d="M130,125 H 160" stroke="#00AEEF" stroke-width="2" />
              <path d="M135,120 H 155" stroke="#00AEEF" stroke-width="2" />
      ...
      <h1 className="text-xl font-bold text-foreground">Innovatrix</h1>
    </div>
  );
}
